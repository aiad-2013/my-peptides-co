...
export const Route = createFileRoute('/blog')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: 'Stay informed with the latest research articles on SARMs, peptides, fitness science, and compound guides. Expert insights from My Peptide Co.' },
    ],
  }),
  component: Blog,
});
