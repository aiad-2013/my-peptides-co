...
export const Route = createFileRoute('/privacy-policy')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: "My Peptide Co's privacy policy. Learn how we collect, use, and protect your personal information in accordance with Australian Privacy Law." },
    ],
  }),
