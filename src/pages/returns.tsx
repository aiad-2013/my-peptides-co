...
export const Route = createFileRoute('/returns')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: 'My Peptide Co returns and refunds policy in accordance with Australian Consumer Law. Unopened products accepted within 30 days. Fast refunds on faulty or incorrect orders.' },
    ],
  }),
  component: Returns,
});
