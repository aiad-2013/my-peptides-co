...
export const Route = createFileRoute('/shipping')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: 'My Peptide Co ships SARMs and peptides Australia-wide. Same-day dispatch on orders before 12pm AEDT. Discreet packaging. 2–5 business day delivery.' },
    ],
  }),
  component: Shipping,
});
