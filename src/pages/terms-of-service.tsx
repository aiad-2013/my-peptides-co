...
export const Route = createFileRoute('/terms-of-service')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: 'Terms and conditions for using the My Peptide Co website. Research use only. Read our terms before purchasing SARMs or peptides in Australia.' },
    ],
  }),
